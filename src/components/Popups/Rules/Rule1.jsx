...
const Rule1 = () => {
  ...
  const handlePlayNow = () => {
    ...
    const gameUrl = `/softgame1/CamPuzzle/index.html?ticketId=${ticketId}`;
    
    // Open game in new tab
    window.open(gameUrl, '_blank');
    
    // Log the action
    console.log(`Playing Campus Puzzle with ticket ID: ${ticketId}`);
    
    // Simulate score return (in real implementation, this would come from the game)
    setTimeout(() => {
      const score = 10;
      console.log(`Game completed with score: ${score}`);
      actions.completeLocation(1, score, 'software');
    }, 2000);
  };
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Navigate through the campus map and solve location-based puzzles
            </span>
          </li>
          ...
          >
            ...
            >
              Complete all puzzle pieces to unlock the next challenge
            </span>
          </li>
